    ...
    <div class="form">
      ...
      <div class="top-form">
        <div class="inner-form">
          <div class="label" for="first_name" style="color: white;">Voornaam <font color="red"> <b>*</b> </font>
          </div>
        ...
        <div class="inner-form">
          <div class="label" for="last_name" style="color: white;">Achternaam <font color="red"> <b>*</b> </font>
          </div>
        ...
        <div class="inner-form">
          <div class="label" for="telephone" style="color: white;">Telefoon nummer <font color="red"> <b>*</b> </font>
          </div>
      ...
      <div class="middle-form">
        ...
        <div class="inner-form">
          <div class="label" for="email" style="color: white;">email adres <font color="red"> <b>*</b> </font>
          </div>
          <input type="text" placeholder="Jouw E-Mail..." name="email" maxlength="80" size="30" required>
        </div>

        <div class="inner-form">
          <div class="label" for="title" style="color: white;">Onderwerp <font color="red"> <b>*</b> </font>
          </div>
      ...
      <div class="bottom-form">
        <div class="inner-form">
          <div class="label" for="comments" style="color: white;">Beschrijving <font color="red"> <b>*</b> </font>
          </div>
